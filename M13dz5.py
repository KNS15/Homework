...
button1 = KeyboardButton(text = 'Посчитать калории')
button2 = KeyboardButton(text = 'Хелп по боту')
...
async def start(message):
    await message.answer('Привет! Я бот помогающий твоему здоровью. '
                         'Введи "Посчитать калории", чтобы узнать норму калорий', reply_markup = kb)
